...
def train(setting_dict, exp_ind):
    ...
    for epoch in range(0, num_epochs):
         ...
         for i,sample in enumerate(train_dataloader,1):
             ...
             if (i + 1) % 50 == 0:
                 if len(dices) != 4:
                     ...
                     wandb.log({'Organ Dice':organ_dice, 'BG Dice':background_dice })
         ...
         torch.save(model.state_dict(), os.path.join(settings.checkpoint_dir, 'encoder_exp_{}.pt'.format(exp_ind)))
         ...
         for i, data in enumerate(val_dataloader):
             ...
             if i%50==0:
                 ...
                 wandb.log({'Val Organ Dice': organ_dice, 'Val BG Dice': background_dice})
