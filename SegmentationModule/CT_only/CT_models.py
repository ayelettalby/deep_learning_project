...
class SegmentationModel(torch.nn.Module):
    ...
    def initialize(self):
        ...
        self.initialize_decoder(self.decoder_kits)
...
class Unet_2D(SegmentationModel):
    def __init__(self,
        ...
        self.decoder_kits = UnetDecoder2D(encoder_channels=self.encoder.out_channels, decoder_channels=decoder_channels,
                                      n_blocks=encoder_depth, use_batchnorm=decoder_use_batchnorm,
                                      center=True if encoder_name.startswith("vgg") else False)
